...
export default function TicketModal({ userData }) {
    ...
    return (
        <div>
            <div className="modal fade" id="reportmodal" data-bs-backdrop="static" tabIndex="-1" aria-labelledby="reportmodalLabel" aria-hidden="true">
                <div className="modal-dialog modal-dialog-scrollable modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h1 className="modal-title fs-5" id="exampleModalLabel">Create Support Ticket</h1>
                        ...
                        <div className="modal-body">
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="form-outline mb-4">
                                    ...
                                    >
                                        <option value="Highest">Highes</option>
                                ...
                                <div className="form-outline mb-4">
                                    <input
                                        ...
                                        disabled
                                    />
                                    <label className="form-label" htmlFor="collection">Email</label>
                                </div>
                                <div className="form-outline mb-4">
                                    <input
                                        type="text"
                                        ...
                                        disabled
                                    />
                                    <label className="form-label" htmlFor="collection">Name</label>
                                </div>
                                <div className="form-outline mb-4">
                                    <input
                                        type="text"
